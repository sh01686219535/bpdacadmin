                                      ...
                                      <form action="{{ route('user_edit',$user->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="name" value="{{ $user->name }}" id="basic-default-name" placeholder="Enter Event Name" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label my-2" for="basic-default-name">Email</label>
                                                <input type="email" class="form-control" value="{{ $user->email }}" name="email" id="basic-default-name" placeholder="Enter Email" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label my-2" for="basic-default-name">Phone</label>
                                                <input type="number" class="form-control" value="{{ $user->phone
                                                 }}" name="phone" id="basic-default-name" placeholder="Enter Phone Number" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label my-2" for="basic-default-name">Specialist</label>
                                                <input type="text" class="form-control" value="{{ $user->specialist }}" name="specialist" id="basic-default-name" placeholder="Enter Specialist At" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label my-2" for="basic-default-name">Working Place</label>
                                                <input type="text" class="form-control" value="{{ $user->working_place }}" name="working_place" id="basic-default-name" placeholder="Enter Working Place" />
                                            </div>
                                            <div class="col-md-6">
